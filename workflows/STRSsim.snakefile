# ==============================================================================
# STRSsim Snakemake workflow
# HEK293T cohesin loop-extrusion simulation — STRS hyperosmotic stress project
#
# Usage:  sbatch SimPipe.sh
#         (or see SimPipe.sh for the full snakemake command)
#
# Inputs (set in config/SimConfig.yaml):
#   hic_control / hic_sorbitol   — STRS .hic contact maps
#   genome                        — hg38 FASTA for FIMO orientation
#   samplesheet                   — SimSamplesheet.txt (CTCF peaks per condition)
#
# Locus + conditions are read from configs/parameters.py (single source of truth).
# Change ACTIVE_LOCUS there to switch between chr1_fig1 / chr4_fig1 / chr6_fig1 /
# chr16_sox8 and re-run.
# ==============================================================================
